		...
		for(int i = 0; i < array.length; i++) {
			for(int j = 0; j < array[i].length; j++) {
				...
				if(temp >=240)
					...
					g2d.setColor(new Color(68 + (int)((temp - 200)* 4.675), 44 + (int)((temp - 200)* 5.275), (int)((temp - 200)* 6.375)));
				else if(temp >=150)
					g2d.setColor(new Color((int)((temp - 150)* 1.36), 112 + (int)((temp - 150)* 1.36), 3 - (int)((temp - 150)* 0.06)));
				else if(temp >=100)
					...
					g2d.setColor(new Color(255 - (int)((temp - 1)* 12.75), 250 + (int)((temp - 1)* 0.25), (int)((temp - 1)* 0.3)));
				else if(temp == 0)
